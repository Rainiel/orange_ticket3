...
<input type="hidden" value="<?php echo base_url(); ?>" id="base1">
    ...
    <!-- Modal Structure -->
		...
		<p style="margin-left: 5px; margin-top: 0px; padding-right: 10px; margin-left: 15px">SUB-ADMIN
            <a class="waves-effect waves-light btn modal-trigger pull-right" href="#modal" style="background-color: #53D530; float: right; padding-left: 20px; margin-left: 15px">
          ...
          <table style="box-shadow: 0px 1px 10px 0px #888888;">
	        <thead style="background: #2d3e50;">
	          <tr>
	              ...
	              <th data-field="name" style="color: white; text-align: center; border-radius: 0px;">Latest Update</th>
	        ...
	        <tbody id="showTicket">
                ...
                <td>28372819</td>
                <td><center>Nerine Ignacio</center></td>
                <td><center>Technical</center></td>
                <td><center>A day ago</center></td>
                <td><center><a class="waves-effect waves-light btn">Update</a></center></td>
	        </tbody>
	      </table>
      	</div>
