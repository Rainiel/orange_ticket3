...
<input type="hidden" value="<?php echo base_url(); ?>" id="base1">
    <div class="row">
		...
		<div class="row cols s12">
            ...
            <a class="waves-effect waves-light btn modal-trigger pull-right" href="#modal1" style="background-color: #53D530; float: right; padding-left: 20px; margin-right: 15px">
        ...
        <form id="addUser">
            <div id="modal1" class="modal" style="width: 500px">
              <div class="modal-content" style="padding: 0;">
                <h4 class="modal-header" style="background-color: #2d3e50; padding: 10px; color: white">Create User<a class="modal-close" id="modalClose" type="button"><i class="fa fa-times pull-right" aria-hidden="true" style="color: #232F3D; font-size: 30px"></i></a></h4>
    	...
    	<div class="col s12" id="ticketTable">
          <table style="box-shadow: 0px 1px 10px 0px #888888;">
	        <thead style="background: #2d3e50;">
	          <tr>
                <th data-field="id" style="color: white; border-radius: 0px;"><center>User ID</center></th>
	              <th data-field="id" style="color: white; border-radius: 0px;"><center>Name</center></th>
	              <th data-field="id" style="color: white; text-align: center; border-radius: 0px;"><center>User</center></th>
                <th data-field="id" style="color: white; text-align: center; border-radius: 0px;"><center>Action</center></th>
	          </tr>
	        </thead>
